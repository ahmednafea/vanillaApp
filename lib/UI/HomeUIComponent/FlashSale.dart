...
import 'package:vanilla/model/FlashSaleItem.dart';
...
import 'package:vanilla/UI/HomeUIComponent/FlashSaleDetail.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 4.0, left: 10.0, right: 10.0, bottom: 15.0),
                      child: Container(
                        height: 5.0,
              ...
              child: Shimmer.fromColors(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 10.0, right: 10.0, top: 8.0),
                      child: Container(
                        height: 10.0,
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 24.0, left: 10.0, right: 10.0, bottom: 15.0),
                      child: Container(
                        height: 7.0,
